...
string randomWord(int tipe){
	...
	if(tipe==1){
        ...
        "QUARRY", "RESTAURANT", "STADIUM", "TRAIN STATION", "UNIVERSITY"};
	}else if(tipe==5){
...
void play(){
	...
	while(true){
		...
		do{
			...
			cout<<"+----------------------------------------+"<<endl;
			cout<<"|"; for(int i=0; i<17; i++) cout<<" "; cout<<"|"<<round<<"/10|";
			for(int i=0; i<18-digit(round); i++) cout<<" "; cout<<"|"<<endl;

			cout<<"|"; for(int i=0; i<14; i++) cout<<" "; cout<<"Scores : "<<skor;
			for(int i=0; i<17-digit(skor); i++) cout<<" "; cout<<"|"<<endl;
...
void leaderboard(){
	...
	if(head!=NULL){
		for(print=head;	print!=NULL; print = print->next){
			cout<<"| "<<nomor; for(int i=0; i<3-digit(nomor); i++) cout<<" "; cout<<"|";
			bool front = true;
			temp=print->nama;
			...
			cout<<print->skor; for(int i=0; i<14-digit(print->skor); i++) cout<<" "; cout<<"|"<<endl;
			nomor++;
		}
		cout<<"+----------------------------------------+"<<endl;
	}else{
