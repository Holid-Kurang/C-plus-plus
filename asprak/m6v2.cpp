...
Room* createDungeon() {
    ...
    Item atkPotion = { "Attack Potion", "Increase attack by 6999", 0, 6999 };
    Item hpPotion = { "Health Potion", "Increase HP by 6999", 6999, 0 };
    room[3].item = new Item(atkPotion); 
    room[4].item = new Item(hpPotion);
...
void displayMap(Room* room) {
    ...
    }bar(); centerText("Room : "+room[currentRoom(room)].roomName);bar();
